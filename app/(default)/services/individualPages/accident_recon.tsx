    ...
    <>
      <div className="tintedPanel flex flex-col items-center gap-10 py-10 px-[5%] 2xl:px-[15%] mb-50">
        ...
        <div className="w-full md:w-7/10 h-auto overflow-hidden shadow-[0_0_8px_white]">
          <Picture
            src="/services/accident_recon/crashSim.gif"
      ...
      <div className="tintedPanel flex flex-col items-center gap-5 py-10 px-5 lg:px-30 2xl:px-75 mb-50">
        <h1 className="text-secondary font-bold text-3xl md:text-4xl text-center">
        ...
        <h1 className="text-secondary font-bold text-xl md:text-3xl mt-30">
          Bicycle Accidents
        </h1>
        <p className="text-base md:text-xl md:mb-10 text-center">
          In 2024, there were
          <span className="text-text-secondary"> 42,000</span> reported bicycle
        ...
        <h1 className="text-text-secondary font-bold text-xl md:text-3xl mt-30">
        ...
        <h1 className="text-secondary font-bold text-xl md:text-3xl text-center mt-30">
        ...
        <p className="text-base md:text-xl md:mb-10 text-center">
          ...
          <RouteLink href={"/services/cdr"} label={"CDR"} />
          ’s.
        </p>
        <YouTubeEmbedMulti
          embedData={[

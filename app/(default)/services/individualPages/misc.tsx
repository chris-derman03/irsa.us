...
const misc = () => {
  return (
    <div className="tintedPanel flex flex-col items-center gap-20 py-10 lg:py-15 px-[5%] 2xl:px-[15%]">
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[5%]">
          ...
          <p className="w-full lg:w-[47.5%] h-auto text-xl font-bold">
            ...
            demonstrates an individual&apos;s loss/potential earnings and
            current monetary capacity. We also include the individual’s
            employment limitations and/or adeptness.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        <Picture
          src="/services/misc/mediation.jpg"
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[5%]">
          ...
          <Picture
            src="/services/misc/product2.jpg"
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[5%]">
          ...
          <Picture
            src="/services/misc/warning2.jpg"
            alt="Broken High Heels"
            override
            className="w-full lg:w-[47.5%] h-auto"
          />
